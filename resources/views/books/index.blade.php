...
<div class="row">
    <div class="col-lg-12 margin-tb">
        <div class="pull-left mt-2">
            <h2>DAFTAR BUKU PERPUSTAKAAN CANDRADIMUKA</h2>
        </div>
    ...
    <tr>
        ...
        <td>
            <form action="{{ route('books.destroy',$book->kode_buku) }}" method="POST">
                <a class="btn btn-info" href="{{ route('books.show',$book->kode_buku) }}">Show</a>
                <a class="btn btn-primary" href="{{ route('books.edit',$book->kode_buku) }}">Edit</a>
                @csrf
                @method('DELETE')
